/**
 * Officer Notifications Page
 * Notifications relevant to the officer (assign/unassign/extension/notes/docs).
 */
...
const EVENT_TYPE_LABELS: Record<string, string> = {
  officer_assigned: "Complaint assigned to you",
  officer_reassigned: "Complaint reassigned",
  officer_unassigned: "Complaint unassigned",
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">
            Updates on your assigned complaints
          </p>
        </div>
